...
const Setup = {
    slides: [
        ...
        { icon: 'ti-trophy', title: 'Play week by week', text: 'Advance the week to roll matches, offers, development and scouting forward. Deals happen in the transfer windows (weeks 1–6 and 21–25).' }
    ],
    idx: 0,
