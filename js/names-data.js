...
const NAMES_DATABASE = {
   ...
   "Brazil": {
    ...
    lastNames: [
        ...
        "Lang", "Scholz", "Möller", "Weiß", "Jung", "Hahn", "Schubert", "Vogel", "Friedrich", "Keller",
        "Günther", "Frank", "Berger", "Winkler", "Roth", "Beck", "Lorenz", "Baumann", "Franke", "Albrecht",
        "Neumann", "Wanner", "Wagner", "Schubert", "Walowitzki", "Podolski", "Neuer", "Löwe", "Bär", "Hack",
        ...
        "Dabrowski", "Kozłowski", "Jankowski", "Mazur", "Kwiatkowski", "Krawczyk", "Piotrowski", "Grabowski", "Nowakowski", 	"Pawłowski", "Ivanov", "Petrov", "Sidorov", "Smirnov", "Popov", "Volkov", "Sokolov", "Lebedev", "Kozlov", "Novikov",
    ...
    firstNames: [
        ...
        "Philippe", "Johan", "Jean", "Jean-Pierre", "Pierre", "Jean-Philippe", "Jean-Jacques", "Jacques", "Corentin",
        "Armand", "Jules", "Patrice", "René", "Randal", "Chris", "Michel", "Martin", "Umberto", "Maxime", "Paul",
        ...
        "Yoann", "Erwan", "Ronan", "Gwenaël", "Morgan", "Alan", "Tanguy", "Estefan", "Maël", "Louan"
    ],
    lastNames: [
        ...
        "Masson", "Sanchez", "Gerard", "Nguyen", "Boyer", "Denis", "Lemaire", "Duval", "Joly", "Gautier", "Gaulle",
        "de Gaulle", "de Manière", "Almanac", "Anorac", "Tissot", "Rouvain", "Champagne", "Philippe", "Malineux",
        "Roger", "Roche", "Roy", "Noel", "Meyer", "Lucas", "Meunier", "Jean", "Perez", "Marchand", "Dembélé",
        ...
        "Alaoui", "Ouattara", "Cain", "Ndiaye", "Sarr", "Fall", "Gueye", "Sy", "Ba", "Seck", "Konaté", "Cissé",
    ...
    firstNames: [
        ...
        "Daan", "Sem", "Lucas", "Milan", "Levi", "Luuk", "Bram", "Finn", "Jesse", "Lars", "Virgil",
        "Thomas", "Tim", "Max", "Stijn", "Thijs", "Jan", "Ruben", "Noah", "Sven", "Niels", "Mats",
        "Jasper", "Rick", "Kevin", "Joris", "Bart", "Jeroen", "Dennis", "Mike", "Tom", "Pieter", "Mark",
        "Floris", "Mees", "Julian", "Sam", "Teun", "Gijs", "Jens", "Hugo", "Olivier", "Lars", "Rob", "Robbie",
        "Robert", "Jeroen", "Jeroen", "Liélio", "Mariano", "Nouz", "Gijs", "Abel", "Joep", "Ben", "Jens", "Mo",
        "Robin", "Wouter", "Maarten", "Martijn", "Stefan", "Erik", "Mark", "Patrick", "Bas", "Sander",
        "Mohamed", "Ahmed", "Ali", "Omar", "Youssef", "Adam", "Ibrahim", "Hassan", "Bilal", "Hamza",
        "Ismail", "Ayoub", "Amine", "Mehdi", "Karim", "Rayan", "Zakaria", "Ilias", "Imran", "Tariq",
        "Murat", "Emre", "Eren", "Ahmet", "Mustafa", "Hasan", "Mehmet", "Burak", "Cem", "Deniz",
        "Emir", "Kerem", "Ömer", "Yusuf", "Can", "Kaan", "Barış", "Onur", "Serkan", "Fatih", "Jip", "Mike",
        "Piotr", "Jakub", "Mateusz", "Kamil", "Tomasz", "Marcin", "Wojciech", "Adrian", "Paweł", "Michał",
        "Arjen", "Rohan", "Devino", "Ravi", "Arman", "Kirano", "Nikhil", "Rahul", "Noah", "Vijay", "Mitchell",
