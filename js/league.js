...
// ============================================================
// Competition names ship GENERIC (copyright-safe) — the real trademarked names (Bundesliga, La Liga,
// Champions League, …) are restored on demand by importing real-club-names.json, which also carries a
// competition-name map (see GameState.compNames / setCompName). Names the game itself invented (Cupa
// Bass, Coppa Compagno, Notre Coupe, Segunda Taça, Primera Superior/Inferior, …) are kept as-is.
const COMPETITIONS = {
    ERE: { name: 'Dutch First Division', short: 'NL1', type: 'league' },
    EED: { name: 'Dutch Second Division', short: 'NL2', type: 'league' },
    TWD: { name: 'Dutch Third Division', short: 'NL3', type: 'league' },
    DRD: { name: 'Dutch Fourth Division', short: 'NL4', type: 'league' },
    PREM: { name: 'English First Division', short: 'EN1', type: 'league' },
    CHAMP: { name: 'English Second Division', short: 'EN2', type: 'league' },
    LEAGUE1: { name: 'English Third Division', short: 'EN3', type: 'league' },
    LEAGUE2: { name: 'English Fourth Division', short: 'EN4', type: 'league' },
    Natleague: { name: 'English Fifth Division', short: 'EN5', type: 'league' },
    BUNDES: { name: 'German First Division', short: 'DE1', type: 'league' },
    '2BUNDES': { name: 'German Second Division', short: 'DE2', type: 'league' },
    '3LIGA': { name: 'German Third Division', short: 'DE3', type: 'league' },
    REGIONAL1: { name: 'German Fourth Division', short: 'DE4', type: 'league' },
    REGIONAL2: { name: 'German Fifth Division', short: 'DE5', type: 'league' },
    REGIONAL3: { name: 'German Sixth Division', short: 'DE6', type: 'league' },
    DFB: { name: 'German Cup', short: 'DE Cup', type: 'cup' },
    LPOKAL: { name: 'Landespokal', short: 'LP', type: 'cup' },
    GRELEG: { name: 'Relegation', short: 'Releg', type: 'playoff' },
    LaLiga: { name: 'Spanish First Division', short: 'ES1', type: 'league' },
    LaLiga2: { name: 'Spanish Second Division', short: 'ES2', type: 'league' },
    PrimeraSup: { name: 'Spanish Third Division', short: 'ES3', type: 'league' },
    PrimeraInf: { name: 'Spanish Fourth Division', short: 'ES4', type: 'league' },
    Segunda: { name: 'Spanish Fifth Division', short: 'ES5', type: 'league' },
    CDR: { name: 'Spanish Cup', short: 'ES Cup', type: 'cup' },
    CFED: { name: 'Copa Federación', short: 'C.Fed', type: 'cup' },
    SuperLeagueCH: { name: 'Swiss First Division', short: 'CH1', type: 'league' },
    ChallengeLeague: { name: 'Swiss Second Division', short: 'CH2', type: 'league' },
    PromotionLeague: { name: 'Swiss Third Division', short: 'CH3', type: 'league' },
    '1.LigaCH': { name: 'Swiss Fourth Division', short: 'CH4', type: 'league' },
    '2.LigaCH': { name: 'Swiss Fifth Division', short: 'CH5', type: 'league' },
    SCHWCUP: { name: 'Swiss Cup', short: 'CH Cup', type: 'cup' },
    ...
    SerieA: { name: 'Italian First Division', short: 'IT1', type: 'league' },
    SerieB: { name: 'Italian Second Division', short: 'IT2', type: 'league' },
    SerieC: { name: 'Italian Third Division', short: 'IT3', type: 'league' },
    SerieD: { name: 'Italian Fourth Division', short: 'IT4', type: 'league' },
    COPPA: { name: 'Italian Cup', short: 'IT Cup', type: 'cup' },
    COPPACOMP: { name: 'Coppa Compagno', short: 'C. Compagno', type: 'cup' },
    Ligue1: { name: 'French First Division', short: 'FR1', type: 'league' },
    Ligue2: { name: 'French Second Division', short: 'FR2', type: 'league' },
    Ligue3: { name: 'French Third Division', short: 'FR3', type: 'league' },
    Ligue4: { name: 'French Fourth Division', short: 'FR4', type: 'league' },
    Ligue5: { name: 'French Fifth Division', short: 'FR5', type: 'league' },
    COUPEFR: { name: 'French Cup', short: 'FR Cup', type: 'cup' },
    COUPENAT: { name: 'Coupe National', short: 'C. Nat', type: 'cup' },
    LigaPortugal: { name: 'Portuguese First Division', short: 'PT1', type: 'league' },
    LigaPortugal2: { name: 'Portuguese Second Division', short: 'PT2', type: 'league' },
    Liga3: { name: 'Portuguese Third Division', short: 'PT3', type: 'league' },
    Liga4: { name: 'Portuguese Fourth Division', short: 'PT4', type: 'league' },
    TACAPT: { name: 'Portuguese Cup', short: 'PT Cup', type: 'cup' },
    SEGTACA: { name: 'Segunda Taça', short: 'Seg. Taça', type: 'cup' },
    JupilerProLeague: { name: 'Belgian First Division', short: 'BE1', type: 'league' },
    ChallengerProLeague: { name: 'Belgian Second Division', short: 'BE2', type: 'league' },
    BelgianDivision1: { name: 'Belgian Third Division', short: 'BE3', type: 'league' },
    BelgianDivision2: { name: 'Belgian Fourth Division', short: 'BE4', type: 'league' },
    BELCUP: { name: 'Belgian Cup', short: 'Cup', type: 'cup' },
    NOTRECOUPE: { name: 'Notre Coupe', short: 'N. Coupe', type: 'cup' },
    BEKER: { name: 'Dutch Cup', short: 'NL Cup', type: 'cup' },
    KBEK: { name: 'De kleine Beker', short: 'kl. Beker', type: 'cup' },
    FACUP: { name: 'English Cup', short: 'EN Cup', type: 'cup' },
    LLC: { name: 'Lower Leagues Cup', short: 'LLC', type: 'cup' },
    PO: { name: 'Promotion Play-off', short: 'PO', type: 'playoff' },
    UCL: { name: 'European Champions Cup', short: 'ECC', type: 'cont' },
    UEL: { name: 'European Cup', short: 'EUR', type: 'cont' },
    UECL: { name: 'European Challenge Cup', short: 'ECh', type: 'cont' },
    JCS: { name: 'Dutch Super Cup', short: 'NL SC', type: 'super' },
    U21: { name: 'U21 League', short: 'U21', type: 'youth', youth: true }
};
// Snapshot of the shipped generic names + shorts. COMPETITIONS is a shared global mutated in place by
// database/import name overlays, so this lets Clubs.init() reset it each game (resetCompetitionNames)
