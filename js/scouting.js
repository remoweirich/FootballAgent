...
const LEAGUE_TIERS = {
    Netherlands: {
        ...
        tiers: [
            ...
            { min: 80, label: 'Eredivisie Star' },
            { min: 73, label: 'Eredivisie Regular' },
            { min: 67, label: 'Eerste Divisie Star' },
            { min: 61, label: 'Eerste Divisie Regular' },
            { min: 55, label: 'Tweede Divisie Star' },
            { min: 49, label: 'Tweede Divisie Regular' },
            { min: 43, label: 'Derde Divisie Star' },
            { min: 37, label: 'Derde Divisie Regular' },
            { min: 31, label: 'Derde Divisie Sub' },
            { min: 0, label: 'Amateur Star' },
        ],
    },
    England: {
        elo: 1085,   // stronger pyramid: the 4th tier edges the Dutch 4th, the top flight beats the Eredivisie
        tiers: [
            { min: 90, label: 'World-Class Superstar' },
            { min: 85, label: 'Premier League Regular' },
            { min: 80, label: 'Championship Star' },
            { min: 73, label: 'Championship Regular' },
            { min: 67, label: 'League One Star' },
            { min: 61, label: 'League One Regular' },
            { min: 55, label: 'League Two Star' },
            { min: 49, label: 'League Two Regular' },
            { min: 43, label: 'National League Star' },
            { min: 37, label: 'National League Regular' },
            { min: 31, label: 'National League Sub' },
            { min: 0, label: 'Amateur Star' },
        ],
    },
};
