...
const POSITION_ROLES = {
    ...
    CB: [
        ...
        { id: 'physical_defender', label: 'Physical defender', goalBias: 0.6, assistBias: 0.2, desc: ['{name} is a strong and physical defender who relishes duels, though he can be caught out by quicker attackers.', 'A tough and uncompromising centre-back, {name} wins battles with strength and aggression. His coolness needs improvement, as he can quickly gather cards'] },
    ],
    LB: [
        { id: 'attacking_fb', label: 'Attacking full-back', goalBias: 0.8, assistBias: 1.7, desc: ['{name} bombs forward relentlessly and whips in dangerous crosses, but leaves space in behind that smarter wingers exploit.', 'An adventurous full-back, {name} provides real width and end product, though his defending is raw.'] },
        ...
        { id: 'defensive_fb', label: 'Defensively solid full-back', goalBias: 0.2, assistBias: 0.7, desc: ['{name} is a disciplined, defensively sound full-back who rarely gets caught out, but offers little going forward.', 'Reliable and positionally sound, {name} keeps it simple — not flashy, but dependable.'] },
    ...
    CDM: [
        { id: 'destroyer', label: 'Ball-winning destroyer', goalBias: 0.4, assistBias: 0.3, desc: ['{name} breaks up play with relish and protects his back four, a real screen — but his passing range is modest.', 'A combative holding midfielder, {name} loves a tackle, though he can over-commit.'] },
    ...
    LW: [
        ...
        { id: 'pace_winger', label: 'Pacey winger', goalBias: 1.2, assistBias: 1.0, desc: ['{name} is a lightning-quick winger who stretches defences and gets in behind, though his final ball can be erratic.', 'A speed merchant on the wing, {name} terrorizes defenders with pace. Technically, he could be refined.'] },
    ],
    RW: [
        { id: 'dribbler', label: 'Direct dribbler', goalBias: 1.1, assistBias: 1.2, desc: ['{name} is an electric dribbler who takes on his man and gets to the byline, thrilling but inconsistent with his final ball.', 'Quick and tricky, {name} beats defenders for fun, though his decision-making in the final third is raw.'] },
        { id: 'inside_forward', label: 'Inside forward', goalBias: 1.5, assistBias: 0.7, desc: ['{name} cuts inside onto his stronger foot and shoots on sight, a one-dimensional but lethal goal threat who rarely sets others up.', 'An inside forward who lives to score, {name} is direct and selfish in the best way, but contributes little build-up.'] },
    ...
    ST: [
        ...
        { id: 'pressing_forward', label: 'Pressing forward', goalBias: 1.0, assistBias: 1.0, desc: ['{name} is a tireless forward who presses defenders and contributes at both ends, though he lacks a defining skill.', 'A hard-working and well-rounded forward, {name} does a bit of everything, though he masters nothing yet.'] },
    ],
};
